...
btn1.addEventListener("click",
    function(){
        ...
        nBefore = n; //nの値をsave
        console.log(n); //★変数nの値をconsoleに出力
        ...
        console.log(omikujiContent.textContent); //★add
        console.log(omikujiContent.style.color); //★add
        console.log(omikujiContent.style.fontSize); //★add
        // おみくじのテキスト画像対応
